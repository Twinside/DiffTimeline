...
var TinySyntaxHighlighter = (function () {
    ...
    var colorLineInNode = function( node, line) {
        var elems = this.colorLine( line );
    ...
    var colorLine = function ( line ) {
        ...
        while (currentIndex < maxIndex)
        {
            ...
            for ( var i = 0; i < current_region.regions.length; i++ )
            {
            ...
            for ( var i = 0; i < current_region.parsers.length; i++ )
            {
    ...
    var create_empty_highlighter = function(with_line_number) {
        ...
        this.colorLineInNode = colorLineInNode;
    ...
    function expand_keyword_groups( lst ) {
        ...
        for ( var group = 0; group < lst.length; group++ )
        {
            var g = lst[group];
            for ( var word = 0; word < g.words.length; word++ )
